...
model.add_layer('eLU1', ELU())
model.add_layer('FC-2', FCLayer(500, 500))
model.add_layer('eLU2', ELU())
model.add_layer('FC-3', FCLayer(500, 300))
model.add_layer('eLU3', ELU())
model.add_layer('FC-4', FCLayer(300, num_of_class))
model.add_layer('Softmax Layer', SoftmaxLayer())
